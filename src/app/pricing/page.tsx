...
export default function PricingPage() {
  ...
  function handleCTAClick(tier: typeof tiers[0]) {
    ...
    // In a standalone page, we can't call parent callbacks, so just show alert
    alert(`Para fazer upgrade para o plano ${tier.name}, entre em contato com o suporte.`);
  }
  ...
  async function handleStartTrial() {
    ...
    try {
      ...
      alert('Teste iniciado com sucesso! Aproveite 14 dias grátis.');
      loadSubscription();
    } catch (error: any) {
