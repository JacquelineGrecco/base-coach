  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="mb-8">
        <button
          onClick={onBack}
          className="flex items-center gap-2 h-12 px-3 text-slate-700 hover:text-slate-900 mb-4 transition-all duration-200 active:scale-95"
        >
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2 tracking-tight">{categoryName}</h1>
