...
- **🏆 Coaches (Treinadores):** Manage teams, evaluate players, and generate reports
- **⚽ Players (Atletas):** Athletes being evaluated (future feature)
...
- Shows user type badge (🏆 Treinador or ⚽ Atleta)
...
- 🔜 View reports generated by coaches
- 🔜 Receive notifications about sessions
- 🔜 Limited interface focused on personal stats
...
- User type badge displayed in header (🏆 Treinador)
...
auth.users (Supabase System)
  ...
  ├── raw_user_meta_data
  │   ├── name
  │   └── user_type  ← stored here during signup
  └── ...
